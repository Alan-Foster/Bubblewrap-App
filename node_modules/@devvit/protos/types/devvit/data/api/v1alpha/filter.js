...
export const FirehoseFilterData_PostFilterData = {
    ...
    fromJSON(object) {
        return {
            adminTakedown: isSet(object.adminTakedown) ? Boolean(object.adminTakedown) : false,
            ...
            approvalStatus: isSet(object.approvalStatus)
                ...
                : 0,
            sexuallyExplicit: isSet(object.sexuallyExplicit) ? Boolean(object.sexuallyExplicit) : false,
        };
    },
    toJSON(message) {
        const obj = {};
        message.adminTakedown !== undefined && (obj.adminTakedown = message.adminTakedown);
        ...
        message.safetyXTag !== undefined &&
            (obj.safetyXTag = message.safetyXTag ? FirehoseFilterData_SafetyTag.toJSON(message.safetyXTag) : undefined);
        message.safetyVTag !== undefined &&
            (obj.safetyVTag = message.safetyVTag ? FirehoseFilterData_SafetyTag.toJSON(message.safetyVTag) : undefined);
        message.approvalStatus !== undefined &&
            (obj.approvalStatus = firehoseFilterData_ApprovalStatusToJSON(message.approvalStatus));
        message.sexuallyExplicit !== undefined && (obj.sexuallyExplicit = message.sexuallyExplicit);
        return obj;
    },
    fromPartial(object) {
        const message = createBaseFirehoseFilterData_PostFilterData();
...
export const FirehoseFilterData_CommentFilterData = {
    ...
    fromJSON(object) {
        return {
            adminTakedown: isSet(object.adminTakedown) ? Boolean(object.adminTakedown) : false,
            abuseScore: isSet(object.abuseScore) ? Number(object.abuseScore) : 0,
    ...
    toJSON(message) {
        const obj = {};
        message.adminTakedown !== undefined && (obj.adminTakedown = message.adminTakedown);
        message.abuseScore !== undefined && (obj.abuseScore = message.abuseScore);
