import { RedisAPI, Metadata, TransactionId, ZMember, HScanResponse, RedisKeyScope } from '@devvit/protos';
import { RedisClient as RedisClientLike, TxClientLike, SetOptions, ZRangeOptions } from '../../types/redis.js';
...
export declare class RedisClient implements RedisClientLike {
    ...
    constructor(metadata: Metadata, storage?: RedisAPI | undefined, scope?: RedisKeyScope);
