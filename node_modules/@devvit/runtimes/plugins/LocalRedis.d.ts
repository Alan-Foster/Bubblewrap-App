import { DoubleValue, Empty, ExpireRequest, HIncrByRequest, IncrByRequest, Int64Value, KeyValuesRequest, KeysRequest, Metadata, RedisAPI, RedisFieldValues, RedisValues, SetRangeRequest, StringValue, TransactionId, TransactionResponses, ZIncrByRequest, ZRankRequest } from '@devvit/protos';
import { RedisClientType, RedisDefaultModules } from 'redis';
import { HDelRequest, HGetRequest, HScanRequest, HScanResponse, HSetRequest, KeyRangeRequest, KeyRequest, KeysResponse, SetRequest, ZAddRequest, ZMembers, ZRangeRequest, ZRemRangeByLexRequest, ZRemRangeByRankRequest, ZRemRangeByScoreRequest, ZRemRequest, ZScoreRequest } from '@devvit/protos';
